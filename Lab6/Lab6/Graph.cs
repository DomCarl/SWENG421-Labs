...
namespace Lab6
{
    public class Graph : GraphIF
    {
        ...
        {
            PaintEventArgs pea = new PaintEventArgs(form.panel1.CreateGraphics(), form.panel1.ClientRectangle);
            int s = 1;
            int v = 1;
            Graphics gra = form.panel1.CreateGraphics();
            Pen blackPen = new Pen(Color.Black, 3);
            SolidBrush sb = new SolidBrush(Color.Red);

            Rectangle r1 = new Rectangle(form.g.vertices[0].x_coord, form.g.vertices[0].y_coord, 1, 1);
            Rectangle r2 = new Rectangle(form.g.vertices[1].x_coord, form.g.vertices[1].y_coord, 1, 1);

            pea.Graphics.DrawEllipse(blackPen, r1.X, r1.Y, r1.Width, r1.Height);
            pea.Graphics.DrawEllipse(blackPen, r2.X, r2.Y, r2.Width, r2.Height);
